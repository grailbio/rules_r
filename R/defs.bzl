...
load("@com_rules_r//R/internal:build.bzl", _r_binary_pkg = "r_binary_pkg", _r_pkg = "r_pkg", _r_source_pkg = "r_source_pkg")
load("@com_rules_r//R/internal:library.bzl", _r_library = "r_library", _r_library_tar = "r_library_tar")
load("@com_rules_r//R/internal:tests.bzl", _r_pkg_test = "r_pkg_test", _r_unit_test = "r_unit_test")
load("@com_rules_r//R/internal:binary.bzl", _r_binary = "r_binary", _r_markdown = "r_markdown", _r_test = "r_test")
load("@com_rules_r//R/internal/toolchains:toolchain.bzl", _r_toolchain = "r_toolchain")
