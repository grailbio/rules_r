...
_COMMON_BUILD_ATTRS = {
    ...
    "_build_pkg_common_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:build_pkg_common.sh",
    ),
    "_build_pkg_bin_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:build_pkg_bin.sh",
        executable = True,
        cfg = "host",
    ),
    "_flock": attr.label(
        default = "@com_rules_r//R/scripts:flock",
        executable = True,
        cfg = "host",
    ),
    "_instrument_R": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:instrument.R",
    ),
}
...
_BUILD_ATTRS = {
    ...
    "_build_pkg_src_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:build_pkg_src.sh",
        executable = True,
        cfg = "host",
    ),
    "_merge_test_files_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:merge_test_files.sh",
        executable = True,
        cfg = "host",
    ),
    "_stamp_description_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:stamp_description.sh",
        executable = True,
        cfg = "host",
    ),
}
...
_BINARY_PKG_ATTRS.update({
    ...
    "_build_binary_sh": attr.label(
        allow_single_file = True,
        default = "@com_rules_r//R/scripts:build_binary.sh",
        executable = True,
        cfg = "host",
    ),
})
