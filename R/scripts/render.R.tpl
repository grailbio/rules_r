...
if (any(c("{input_argument}", "{output_dir_argument}") %in% names(list({render_args})))) {
...
function_args <- list({input_argument}=input, {output_dir_argument}=output_dir{render_args})
function_args <- c(function_args, cmd_flags_list)
